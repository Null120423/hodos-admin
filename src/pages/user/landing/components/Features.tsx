  ...
  const features = [
    {
      ...
      description:
        "AI-powered multilingual chatbot helps you navigate the city and communicate with locals effortlessly.",
    ...
    },
    {
      ...
      description:
        "Personalized travel plans based on your interests, budget, and time constraints with AI recommendations.",
    ...
    },
    {
      ...
      description:
        "Virtual tours of destinations before you visit, helping you make informed decisions about your journey.",
    ...
    },
    {
      ...
      description:
        "Take photos to instantly identify landmarks, dishes, and cultural sites with detailed information.",
    ...
    },
    {
      ...
      description:
        "Share your travel stories, photos, and reviews with the community to help other travelers.",
    ...
    },
    {
      ...
      description:
        "Find like-minded travelers, join groups, and share experiences to make new friends during your journey.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover Ho Chi Minh City with confidence using our comprehensive
            suite of AI-powered travel tools.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div
                  className={`absolute top-4 left-4 w-12 h-12 rounded-lg ${feature.color} flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300`}
                >
