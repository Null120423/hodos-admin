...
const Demo = () => {
  ...
  return (
    <section
      className="py-20 bg-gradient-to-br from-gray-50 to-sky-50 overflow-hidden"
      id="demo"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience the power of AI-guided travel through our intuitive
            interface designed specifically for Ho Chi Minh City explorers.
          </p>
        </div>
          ...
          <div className="animate-slide-in-left">
            <div className="bg-white rounded-2xl p-8 shadow-xl transform hover:scale-105 transition-transform duration-500">
              ...
              <p className="text-gray-600 mb-6">
                Watch how our AI assistant helps you discover hidden gems, plan
                your itinerary, and navigate Ho Chi Minh City like a local.
              </p>
            ...
            <div>
              ...
              <div className="grid gap-4">
                {features.map((feature, index) => (
                  ...
                  >
                    <feature.icon
                      className={`w-6 h-6 ${feature.color} mr-3 animate-bounce-gentle`}
                    />
        ...
        <div className="mt-20 animate-fade-in-up animation-delay-600">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              See how travelers are exploring Ho Chi Minh City with our AI
              assistant
            </p>
          </div>
