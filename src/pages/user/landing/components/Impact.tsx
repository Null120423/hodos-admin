import { Globe, Heart, Smartphone, Users } from "lucide-react";
  ...
  const impacts = [
    {
      ...
      description:
        "Showcase the rich heritage and vibrant culture of Ho Chi Minh City to international visitors",
      image:
    ...
    },
    {
      ...
      description:
        "Give confidence to independent travelers exploring the city on their own",
      image:
    ...
    },
    {
      ...
      description:
        "Create intuitive and accessible technology that enhances rather than complicates travel",
      image:
    ...
    },
    {
      ...
      description:
        "Foster meaningful connections between travelers and locals through intelligent technology",
      image:
        "https://images.pexels.com/photos/1320684/pexels-photo-1320684.jpeg?auto=compress&cs=tinysrgb&w=400",
    },
  ];
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/2 right-20 w-24 h-24 rounded-full overflow-hidden animate-float animation-delay-300">
          <img
            alt=""
            className="w-full h-full object-cover"
            src="https://images.pexels.com/photos/2901209/pexels-photo-2901209.jpeg?auto=compress&cs=tinysrgb&w=200"
          />
        </div>
        <div className="absolute bottom-20 left-1/4 w-28 h-28 rounded-full overflow-hidden animate-float animation-delay-600">
          <img
            alt=""
            className="w-full h-full object-cover"
            src="https://images.pexels.com/photos/1320684/pexels-photo-1320684.jpeg?auto=compress&cs=tinysrgb&w=200"
          />
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-xl text-sky-100 max-w-3xl mx-auto">
            Our mission goes beyond just helping tourists navigate the city.
            We're building bridges between cultures and creating memorable
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-4 group-hover:bg-white/20 transition-all duration-300 transform group-hover:scale-105 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-lg font-bold mb-3">{impact.title}</h3>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto animate-fade-in-up animation-delay-800">
          <h3 className="text-2xl font-bold mb-6 text-center">
            Smart travel, meaningful connection – powered by AI
          </h3>
          ...
          <p className="text-sky-100 text-lg text-center">
            Join thousands of travelers who have discovered the magic of Ho Chi
            Minh City with our AI-powered assistant. Experience Vietnam like
            never before with personalized guidance that adapts to your unique
            travel style.
          </p>
        </div>
      </div>
